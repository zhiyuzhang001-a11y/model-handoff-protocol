...
### M0 — `<name>` — `<PLANNED | ACTIVE | COMPLETE>`

- Goal: `<bounded result>`
- Non-goals: `<deferred work>`
- Execution routing: `<economical model for most bounded units; capable model for planning/verification and judgment-heavy or high-risk units; independent verification owner>`
...
1. `<future bounded direction>`

Deferred items are not active authorization. Create a milestone contract before
implementation.
